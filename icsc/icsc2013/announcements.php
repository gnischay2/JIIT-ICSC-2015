<?php
$all=array();
if (($handle = fopen("announce.csv", "r")) !== FALSE) {
    ...
    <div class="b_page clearfix">
        <div id="content">
            <div class="b w_940">
											...
											<h2 class="entry-title ">Latest Annocements</h2>
<!--<p><h3 style="font-family : calibri; font-size : 16px;">Brief details of Hotels are listed below :</h3></p>--><br /><br />
				            </div>
            <!-- left sidebar -->
			...
			<?php
			for($i=sizeof($all)-1;$i>-1;$i--)
			{
             echo '<li><h5 style="font-weight: 100; font-family: Calibri;">'.$all[$i].'</h5></li>';
...
?>	
        ...
        <div id="primary">
		<!--right side-->
		<div class="b w_300"><ul class="xoxo"><li id="registration-4" class="widget"><div class="registration">
		<p>2013 - ICSC</p><p class="desc">December 12 - 14, 2013</p><p class="exc">Jaypee Institute of Information Technology</p>
		<p class="button hover blue register no_float"><a href="reg.php">register for the event<span>&nbsp;</span></a></p>
		<div class="end">&nbsp;</div>
		</div></li>
		<li id="registration-4" class="widget"><div class="registration">
		<p>Hotel Details</p><p class="desc"></p><p class="exc"></p>
		<p class="button hover blue register no_float"><a href="hotel.php">Browse all hotels<span>&nbsp;</span></a></p>
		<div class="end">&nbsp;</div>
		</div></li>		
		</ul>
		</div></div>
