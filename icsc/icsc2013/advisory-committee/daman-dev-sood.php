...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Daman Dev Sood</title>
...
-->
    ...
    <body  class="single single-advisory-committee postid-262 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-262 advisory-committee type-advisory-committee status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Mr. Daman Dev Sood</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="size-full wp-image-233 alignleft" alt="" src="../2013/04/Untitled3.jpg" /></p>
<p style="text-align: justify;">As Business Continuity Manager of the Year in BCI’s C&amp;R Awards India 2009, and with over 25 years’ experience in IT Industry, Daman is current <strong>CIO and Head – Sustainability Practice at Continuity </strong><strong>and Resilience</strong> .He has earlier worked with Steria as Head Business Continuity Management (UK, India) &amp; Head Green Activities (India). Initially he worked with TCS for over 20 years in various roles and positions. He has rich experience in Environmental Sustainability, Business Continuity Management, Business Excellence and Consulting (BCM, Green IT, Quality/ Process/ Malcolm Baldrige). He is a Lead Auditor for BS 25999 (Business Continuity Management System). Daman is Accredited Tutor for BCS ISEB “Foundation Certificate in Green IT” course</p>
<p>Daman is a Fellow of the BCS (The Chartered Institute for IT, earlier known as the British Computer Society), an Associate Member of the BCI (Business Continuity Institute), Senior Member of IEEE (Institute of Electrical and Electronics Engineers) and Secretary of IEEE Delhi Section. He is a member of AIMA (All India Management Association) and Member of DMA (Delhi Management Association).</p>
                                                                            </div>
                                </li>
                            </ul>
