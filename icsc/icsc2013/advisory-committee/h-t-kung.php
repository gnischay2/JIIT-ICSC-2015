...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. H. T. Kung</title>
...
-->
    ...
    <body  class="single single-advisory-committee postid-258 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-258 advisory-committee type-advisory-committee status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof. H. T. Kung</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="size-full wp-image-233 alignleft" alt="" src="../2013/04/Untitled4.jpg" /></p>
<p style="text-align: justify;">H. T. Kung is William H. Gates Professor of Computer Science and Electrical Engineering at Harvard University. He is interested in computing, communications and sensing, with a current focus on wireless networking and compressive sensing. Prior to joining Harvard in 1992, he taught at Carnegie Mellon University for 19 years after receiving his Ph.D. there. Professor Kung has pursued a variety of research interests in his career, including complexity theory, database systems, VLSI design, parallel computing, computer networks, network security, wireless communications, and networking of unmanned aerial systems. To complement his academic activities, Professor Kung maintains a strong link with industry. He has served as a consultant and board member to numerous companies and government organizations. Professor Kung&#8217;s professional honors include: Member of the National Academy of Engineering, Member of the Academia Sinica (in Taiwan), and Guggenheim Fellowship.</p>
                                                                            </div>
                                </li>
                            </ul>
