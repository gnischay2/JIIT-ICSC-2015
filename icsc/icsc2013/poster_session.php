    ...
    <div class="b_page clearfix">
        <div id="content">
            ...
            <div class="post-395 page type-page status-publish hentry post">
                            ...
                            <div class="b w_940">
                                <h2 class="entry-title">Poster Session Details</h2>
                            </div>
                <div class="b w_620">
...
<img src="images/schedule/poster1.jpg" alt="" usemap="#logos" style="border:none;background:none;" /></p>
<img src="images/schedule/poster2.jpg" alt="" usemap="#logos" style="border:none;background:none;margin-top:-51px;" /></p>
