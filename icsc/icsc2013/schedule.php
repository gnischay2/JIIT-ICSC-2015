...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Schedule</title>
...
<br/>
<div style="font-family:calibri;font-size:15px;margin-top:-10px;"><marquee behavior="alternate" scrollamount="2"><b><?php $homepage = file_get_contents('notice.php');echo $homepage; ?></b></marquee></div>
    ...
    <div class="b_page clearfix">
        <div id="content">
            ...
            <div class="post-395 page type-page status-publish hentry post">
                            ...
                            <div class="b w_940">
                                <h2 class="entry-title">Conference Schedule</h2><br/><a href="poster_session.php"><h4>Poster Session details</h4></a><br/>
								<a href="schedule.pdf" target="_blank"><h4>Printable Format</h4></a>
                            </div>
                <div class="b w_620">
...
<div id="tabs-1">
<p>                                           
<img src="images/schedule/reg_paper_schedule-page-001.jpg" alt="" usemap="#logos" style="border:none;background:none;" /></p>
<img src="images/schedule/reg_paper_schedule-page-002.jpg" alt="" usemap="#logos" style="border:none;background:none;margin-top:-51px;" /></p>
</p>
</div>
<div id="tabs-2">
<p>
<img src="images/schedule/reg_paper_schedule-page-003.jpg" alt="" usemap="#logos" style="border:none;background:none;" /></p>
<img src="images/schedule/reg_paper_schedule-page-004.jpg" alt="" usemap="#logos" style="border:none;background:none;margin-top:-51px;" /></p>
</p>
</div>
<div id="tabs-3">
<p>
<img src="images/schedule/reg_paper_schedule-page-005.jpg" alt="" usemap="#logos" style="border:none;background:none;" /></p>
<img src="images/schedule/reg_paper_schedule-page-006.jpg" alt="" usemap="#logos" style="border:none;background:none;margin-top:-51px;" /></p>
</p>
</div>
</div>
<p></p>
<p></p>
<blink><a href="poster_session.php"><h3 id="poster">Poster Session details</h3></a></blink>
<br/><br/>
<h3>Printable Format</h3>
<p>
<a href="schedule.pdf" target="_blank"><img src="images/download.png"/></a>
</p>
<!--<map name="logos">
